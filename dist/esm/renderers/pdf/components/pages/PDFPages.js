...
var PDFPages = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DocumentPDF, { file: currentDocument.fileData, onLoadSuccess: function (_a) {
                var numPages = _a.numPages;
                return dispatch(setNumPages(numPages));
            }, loading: React.createElement("span", null, t("pdfPluginLoading")) }, paginated ? (React.createElement(PDFSinglePage, { documentOverlay: props.documentOverlay })) : (React.createElement(PDFAllPages, { documentOverlay: props.documentOverlay })))));
};
