...
var PDFSinglePage = function (_a) {
    var pageNum = _a.pageNum, documentOverlay = _a.documentOverlay;
    ...
    return (React.createElement(PageWrapper, { id: "pdf-page-wrapper" },
        documentOverlay && (React.createElement("div", { style: {
                zIndex: 99,
                position: "absolute",
                width: "100%",
                height: "100%",
